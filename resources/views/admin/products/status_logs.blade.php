...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Lịch sử thay đổi trạng thái: {{ $product->name }}</h1>
    <a href="{{ route('admin.products.index') }}" class="mb-4 inline-block text-blue-500">Quay lại danh sách sản phẩm</a>
