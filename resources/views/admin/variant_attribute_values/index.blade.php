...
<div class="w-full px-6 py-6 mx-auto">
  <h6 class="dark:text-white text-lg font-semibold">Thêm giá trị thuộc tính cho biến thể sản phẩm</h6>

  <form action="{{ route('admin.variant-attribute-values.store') }}" method="POST" class="p-6">
    @csrf
    ...
    <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 rounded">Lưu giá trị thuộc tính cho biến thể</button>
  </form>
</div>
@endsection
