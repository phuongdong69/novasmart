                ...
                <div class="flex-auto px-0 pt-4 pb-2">
                    <form action="{{ route('admin.variant_attribute_values.store') }}" method="POST" class="max-w-xl mx-auto">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="value" id="value" class="border border-slate-300 rounded px-3 py-2 w-full text-sm focus:outline-none focus:ring focus:border-blue-300" value="{{ old('value') }}" required>
                            @error('value')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        </div>
