            ...
            <div class="flex-auto px-6 py-4">
                <form method="POST" action="{{ route('admin.brands.store') }}">
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" name="name" class="w-full rounded-lg border border-stroke bg-transparent py-3 px-4.5 text-black dark:border-form-strokedark dark:bg-form-input dark:text-white" placeholder="Nhập tên nhãn hiệu" required />
                    </div>
                    <div class="mt-6">
