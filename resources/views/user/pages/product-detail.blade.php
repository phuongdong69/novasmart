                        ...
                        <ul class="product-imgs flex list-none items-center">
                            <li>
                                <ul class="img-select list-none">
                                    <li class="p-px">
                                        <a href="#" data-id="1">
                                            <img src="assets/images/shop/mens-jecket.jpg" class="shadow-sm dark:shadow-gray-800" alt="">
                                        </a>
                                    </li>
                                    <li class="p-px">
                                        <a href="#" data-id="2">
                                            <img src="assets/images/shop/mens-jecket-3.jpg" class="shadow-sm dark:shadow-gray-800" alt="">
                                        </a>
                                    </li>
                                    <li class="p-px">
                                        <a href="#" data-id="3">
                                            <img src="assets/images/shop/mens-jecket-left.jpg" class="shadow-sm dark:shadow-gray-800" alt="">
                                        </a>
                                    </li>
                                    <li class="p-px">
                                        <a href="#" data-id="4">
                                            <img src="assets/images/shop/mens-jecket-back.jpg" class="shadow-sm dark:shadow-gray-800" alt="">
                                        </a>
                                    </li>
                                    <li class="p-px">
                                        <a href="#" data-id="5">
                                            <img src="assets/images/shop/mens-jecket-4.jpg" class="shadow-sm dark:shadow-gray-800" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </li>

                            <li class="overflow-hidden shadow-sm dark:shadow-gray-800 m-px">
