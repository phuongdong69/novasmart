            ...
            <li class="dropdown inline-block relative ps-0.5">
                ...
                <div class="dropdown-menu absolute end-0 mt-4 z-10 w-72 rounded-md bg-white dark:bg-slate-900 shadow-sm dark:shadow-gray-800 hidden" onclick="event.stopPropagation();">
                    <ul class="py-3 text-start max-h-96 overflow-auto">
                            ...
                            <a href="#" class="flex items-center justify-between py-1.5 px-4">
                                <div class="flex items-center gap-3 overflow-hidden w-full">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm text-slate-400">${{ number_format($price, 2) }} × {{ $quantity }}</p>
                                    </div>
                                </div>
                        ...
                        @empty
                        <li class="px-4 py-2 text-center text-sm text-gray-500">Giỏ hàng trống</li>
                        @endforelse

                        <li class="border-t border-gray-100 dark:border-gray-800 my-2"></li>

                        <li class="flex items-center justify-between py-1.5 px-4">
                            <h6 class="font-semibold mb-0 text-sm">Total($):</h6>
                            <h6 class="font-semibold mb-0 text-sm">${{ number_format($cartTotal, 2) }}</h6>
                        </li>

                        <li class="py-1.5 px-4">
                            <div class="text-center space-x-2">
                                <a href="{{ route('cart.show') }}" class="py-[5px] px-4 inline-block font-semibold text-sm rounded-md bg-orange-500 text-white">View Cart</a>
                                <a href="" class="py-[5px] px-4 inline-block font-semibold text-sm rounded-md bg-orange-500 text-white">Checkout</a>
                            </div>
                    ...
                    <ul class="submenu megamenu">
                        ...
                        <li>
                            <ul>
                                ...
                                <li class="text-center"> <a href="{{ route('user.products.index') }}" class="py-2 px-5 inline-block font-medium tracking-wide align-middle duration-500 text-base text-center bg-orange-500/10 text-orange-500 rounded-md me-2 mt-2"> <i class="mdi mdi-cart-outline"></i> Shop Now </a> </li>
                            </ul>
                        </li>
                    </ul>
                </li>
